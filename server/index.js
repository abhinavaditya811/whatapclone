...
const URI =
	...
	"mongodb+srv://illGamerGuy12:abhinav811@whatapclone.8ym2p.mongodb.net/whatapclone?retryWrites=true&w=majority";
mongoose
	.connect(URI, {
...
io.on("connection", (socket) => {
	...
	socket.on("sendGroupMessage", ({ sender, recipient, token, message }) => {
		createGroupMessage(sender, token, recipient, message).then((res) => {
